    ...
    <div class="acu-settings-group">
      <div class="acu-settings-row">
        <div class="acu-settings-control" style="width: 100%">
          <input v-model="searchQuery" type="text" class="acu-search-input" placeholder="搜索词库名称..." />
        </div>
      </div>
    </div>
        ...
        <div class="acu-settings-row">
          <div class="acu-settings-label">
            <div style="display: flex; align-items: center; gap: 8px">
              ...
              <!-- 倾向徽章 -->
              <span v-if="category.bias === 'positive'" class="acu-badge acu-badge-success" style="font-size: 10px"
                >吉</span
              >
              <span v-else-if="category.bias === 'negative'" class="acu-badge acu-badge-danger" style="font-size: 10px"
                >凶</span
              >

              <!-- 强制抽取数量 -->
              <span v-if="category.limit > 0" class="acu-badge" style="font-size: 10px; background: var(--acu-btn-bg)">
                强抽: {{ category.limit }}
              </span>
            </div>
