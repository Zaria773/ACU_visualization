        ...
        <div class="acu-settings-row">
          <div class="acu-settings-label">
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <!-- 倾向徽章 -->
              <span v-if="category.bias === 'positive'" class="acu-badge acu-badge-success" style="font-size: 10px;">吉</span>
              <span v-else-if="category.bias === 'negative'" class="acu-badge acu-badge-danger" style="font-size: 10px;">凶</span>
