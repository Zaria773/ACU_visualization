  ...
  <div v-if="visible" class="acu-modal-container acu-crop-modal-overlay" @click.self="handleClose">
    <div class="acu-modal acu-crop-dialog">
      ...
      <div class="acu-modal-body acu-crop-body">
        ...
        <!-- 反色选项 - 仅当 showInvertOption 为 true 时显示 -->
        <div v-if="showInvertOption" class="acu-crop-invert-section">
          <div class="acu-settings-row">
            <div class="acu-settings-label">
              <i class="fas fa-adjust"></i>
              反色效果
              <span class="hint">白变黑/黑变白</span>
            </div>
...
const emit = defineEmits<{
  ...
  (e: 'close'): void;
  /** 应用更改 */
  (e: 'apply', data: { offsetX: number; offsetY: number; scale: number; invert?: boolean }): void;
  /** 上传新图片 */
